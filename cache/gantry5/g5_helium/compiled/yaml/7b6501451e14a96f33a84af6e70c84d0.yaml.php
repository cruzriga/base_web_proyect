...
return [
    ...
    'filename' => '/home/qmvlbbvr/public_html/templates/g5_helium/custom/particles/gp_accordion1.yaml',
    'modified' => 1607749066,
    'data' => [
        'name' => 'Gp Accordion 1',
        ...
        'form' => [
            'fields' => [
                ...
                '_note_demo' => [
                    ...
                    'content' => '<h4 style="margin:0;"><a href="https://gantry5particles.com/i/accordion-1" target="_blank"><i class="fa fa-external-link"></i> See demo</a></h4>'
                ],
                'tabs' => [
                    'type' => 'container.tabs',
                    'fields' => [
